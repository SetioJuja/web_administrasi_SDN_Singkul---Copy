...
<button id="btnTambah" class="btn-primary" style="margin-bottom:20px;">
    Tambah
</button>
...
<button onclick="updateData()" class="btn-primary">Update</button>
...
function loadData(){
    ...
    .then(res=>{
        ...
        if(!allData.length){
            html = `<tr><td colspan="7">Belum ada jadwal</td></tr>`;
        }
        ...
        allData.forEach(j=>{
            ...
            <tr>
                ...
                <td>
                    <button onclick="openModal(${j.id_jadwal})" class="btn-primary">Edit</button>
                    <button onclick="hapus(${j.id_jadwal})" class="btn-danger">Hapus</button>
                </td>
            </tr>`;
        });
...
function openModal(id){
    ...
    let j = allData.find(x => x.id_jadwal == id);

    edit_id.value = j.id_jadwal;
    edit_hari.value = j.hari;
    edit_jam_mulai.value = j.jam_mulai;
    edit_jam_selesai.value = j.jam_selesai;

    edit_guru.value = j.id_guru;
    edit_kelas.value = j.id_kelas;
    edit_mapel.value = j.id_mapel;
    edit_tahun.value = j.id_tahun_ajaran;
...
function updateData(){
    ...
    fetch('/api/jadwal/'+edit_id.value,{
        ...
        body: JSON.stringify({
            _method:'PUT',
            hari: edit_hari.value,
            jam_mulai: edit_jam_mulai.value,
            jam_selesai: edit_jam_selesai.value,
            id_guru: edit_guru.value,
            id_kelas: edit_kelas.value,
            id_mapel: edit_mapel.value,
